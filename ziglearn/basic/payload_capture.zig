// Payload captrues use the syntax |value| and appear in many places, some of which we've seen already. Wherever they appear they are used to capture the value from something.
// With if statement and options
